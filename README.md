...
Its used as a kind of badge to let you login. It gives the user authentication.

-   [ ] What steps can you take in your web apps to keep your data secure?

You can manage your data in a store and create api keys so that only certain people can access the data. Never share the key.

-   [ ] Describe how web servers work.

They are the computers that that interact with the requests to access data. They also use web server code to maintain.

-   [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. .get, .post. .put, .delete
